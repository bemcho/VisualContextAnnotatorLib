...
public:
	...
	void detectObjectsWithCanny(vector<Rect>& result, Mat& frame, double lowThreshold = 77, Size minSize = Size(100, 100));
	void detectObjectsWithCanny(vector<vector<Point>>& result, Mat& frame, double lowThreshold = 77, Size minSize = Size(100, 100));
